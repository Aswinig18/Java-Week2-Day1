...
public class Salesforce {
	...
	public static void main(String[] args) {
		...
		driver.findElementByName("UserFirstName").sendKeys("Aswini");
		driver.findElementByName("UserLastName").sendKeys("Gunasekaran");
		driver.findElementByName("UserEmail").sendKeys("gaswini313@gmail.com");
		...
		driver.findElementByName("UserPhone").sendKeys("1234567898");
